...
export interface ProductDetails_categories_backgroundImage {
  __typename: "Image";
  /**
   * Alt text for an image.
   */
...
export interface ProductDetails_categories {
  ...
  name: string;
  slug: string;
  backgroundImage: ProductDetails_categories_backgroundImage | null;
  description: string;
  descriptionJson: any;
}
...
export interface ProductDetails_variants_color {
...
export interface ProductDetails_variants {
   ...
   */
  color: ProductDetails_variants_color | null;
  /**
...
export interface ProductDetails_colors {
  __typename: "VariantColor";
  /**
   * Color name
   */
...
export interface ProductDetails {
   ...
   */
  categories: (ProductDetails_categories | null)[] | null;
  /**
   ...
   */
  colors: (ProductDetails_colors | null)[] | null;
  /**
