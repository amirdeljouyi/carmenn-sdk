...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_color {
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant {
   ...
   */
  color: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_color | null;
